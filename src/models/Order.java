...
public class Order {
    ...
    public String toString() {
        return "";
//        return String.format("Order ID: %d, Customer Name: %s, Coffee Name: %s, Number Ordered: %.2f, Total: %.2f",
//                orderId, customer.getCustomerName(), coffee.getCoffeeName(), numberOrdered, total);
    }
